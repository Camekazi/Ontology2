...
exports.DefaultTaxonomy = exports.DEFAULT_TAXONOMY_CLASSES = void 0;
exports.DEFAULT_TAXONOMY_CLASSES = [
    {
        id: 'time-period',
        name: 'TimePeriod',
...
class DefaultTaxonomy {
    constructor() {
        this.id = 'dotwork-default';
        this.name = 'Dotwork Default Taxonomy';
        this.version = '1.0.0';
        this.description = 'Default 10-class taxonomy for narrative-to-ontology transformation';
        this.classes = exports.DEFAULT_TAXONOMY_CLASSES;
    }
    getClass(id) {
    ...
    findMatchingClasses(text) {
        const matches = [];
        const lowerText = text.toLowerCase();
        for (const taxonomyClass of this.classes) {
            // Check keywords
            const keywordMatch = taxonomyClass.keywords.some(keyword => lowerText.includes(keyword.toLowerCase()));
            // Check patterns
    ...
    calculateConfidence(text, taxonomyClass) {
        const lowerText = text.toLowerCase();
        let score = 0;
        let maxScore = 0;
...
exports.DefaultTaxonomy = DefaultTaxonomy;
//# sourceMappingURL=DefaultTaxonomy.js.map